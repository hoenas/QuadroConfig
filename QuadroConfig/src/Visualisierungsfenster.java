...
public class Visualisierungsfenster extends JFrame {
	...
	public Visualisierungsfenster() {
		...
		liveXYViewer_velocity = new LiveXYViewer(Color.BLACK, Color.GREEN, 10, 2, 100, 50, Color.WHITE, true, 1, 10, true, 25, Color.GREEN);
		...
		liveXYViewer_accel = new LiveXYViewer(Color.BLACK, Color.GREEN, 10, 2, 100, 50, Color.WHITE, true, 1, 10, true, 25, Color.GREEN);
		...
		liveXYViewer_motor = new LiveXYViewer(Color.BLACK, Color.GREEN, 10, 2, 100, 50, Color.WHITE, true, 1, 10, true, 25, Color.GREEN);
